...
public class PrinterTest implements Printable{
    ...
    public void generatePaperWithData(Patient patient, int noOfCopies, String injectionName, String injectionPrice) {
        
        this.injectionName = injectionName;
        this.injectionPrice = injectionPrice;
        ...
        array1[15] = injectionPrice;//String.valueOf(patient.getRecieptNumber());//now price
        array1[16] = String.valueOf(patient.getDiscount());
        //JOptionPane.showMessageDialog(null, String.valueOf(Float.parseFloat(injectionPrice) - patient.getDiscount() - patient.getAdvane()));
        array1[17] = String.valueOf(Float.parseFloat(injectionPrice) - patient.getDiscount() - patient.getAdvane());// T 1
        ...
        if(patient.getUser().equals("1")){
            array1[24] = "Admin";
        }
        else{
            array1[24] = patient.getUser();
        }
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        if (pageIndex < noOfCopies) {
            ...
            g2d.drawString("V.A  : ", x, y + col1);col1+=inc1;
            ...
            col1+=inc1;
            g2d.drawString(array1[22], x + inc2, y + col1);col1+=inc1;//va
            ...
            g2d.drawString("prcjr : ", x + inc2, y + col1);
            g2d.drawString(array1[23], x + inc2 + 30, y + col1);col1+=inc1;//fold pc iol
            g2d.drawString("Ref Dr : ", x + inc2+10, y + col1);
            ...
            g2d.drawString(array1[24], x + inc2, y + col1);col1+=inc1;//user
            
            DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("dd/MM/YY");
            //DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("hh:mm a");
            
            g2d.drawString("Date: "+dateFormatter.format(LocalDateTime.now()), x + inc2-25, y + col1);col1+=inc1;//date
            //g2d.drawString(timeFormatter.format(LocalDateTime.now()), x + inc2, y + col1);col1+=inc1;//time*/
